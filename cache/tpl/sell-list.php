...
<div class="m_l_1 f_l">
	<div class="left_box">		
		...
		<a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('index.php?typeid='.$k.'&catid='.$catid);?>" class="type_2"><?php echo $v;?></a>
		<?php } } ?>
		</div>
		...
		<?php echo tag("moduleid=$moduleid&condition=status=3&catid=$catid&pagesize=".$MOD['pagesize']."&page=$page&showpage=1&update=1&datetype=5&group=".$MOD['group']."&order=".$MOD['order']."&fields=".$MOD['fields']."&template=list-sell");?>
		<div class="tool">
			<table>
			<tr height="30">
...
<div class="m_r_1 f_l">
	...
	<div class="box_body">
		...
		<?php if($k%2==0) { ?><tr><?php } ?>
		<td><a href="<?php echo $MOD['linkurl'];?><?php echo rewrite('search.php?areaid='.$v['areaid'].'&catid='.$catid);?>"><?php echo $v['areaname'];?></a></td>
		<?php if($k%2==1) { ?></tr><?php } ?>
		<?php } } ?>
		</table>
	</div>
