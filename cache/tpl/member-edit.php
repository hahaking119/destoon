...
<form method="post" action="<?php echo $MOD['linkurl'];?>edit.php" onsubmit="return Dcheck();" id="dform">
...
<td class="tr"><?php echo $_email;?><?php if($vemail) { ?>&nbsp;&nbsp;<img src="image/v_email.gif" title="已认证" align="absmiddle"/><?php } ?>&nbsp;&nbsp;<a href="<?php echo $MOD['linkurl'];?>send.php?action=email" class="t">[修改]</a></td>
</tr>
<?php if($vtruename) { ?>
<tr>
...
<tr>
<td class="tl">联系地址</td>
<td class="tr"><input type="text" size="40" name="post[address]" id="address" value="<?php echo $address;?>"/>&nbsp;<span id="daddress" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">联系电话</td>
...
<tr>
<td class="tl">手机号码</td>
<td class="tr"><input type="hidden" name="post[mobile]" id="mobile" value="<?php echo $mobile;?>"/><?php echo $mobile;?>&nbsp;&nbsp;<img src="image/v_mobile.gif" title="已认证" align="absmiddle"/>&nbsp;&nbsp;<a href="<?php echo $MOD['linkurl'];?>send.php?action=mobile" class="t">[修改]</a></td>
</tr>
<?php } else { ?>
<tr>
<td class="tl">手机号码</td>
...
<td class="tr f_red"><input type="password" size="20" name="post[oldpayword]" id="oldpayword"/>&nbsp; 支付密码默认和注册设置密码相同&nbsp;&nbsp;<a href="<?php echo $MOD['linkurl'];?>send.php?action=payword"  class="t">找回支付密码</a><span id="doldpayword" class="f_red"></span></td>
</tr>
...
<tr>
<td class="tl">形象图片</td>
<td class="tr"><input name="post[thumb]" type="text" size="60" id="thumb" value="<?php echo $thumb;?>" readonly/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>,<?php echo $MOD['thumb_width'];?>,<?php echo $MOD['thumb_height'];?>, $('thumb').value, true);" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview($('thumb').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="$('thumb').value='';" class="jt">[删除]</span><br/>
...
<tr>
<td class="tl"><span class="f_red">*</span>主要经营地点</td>
<td class="tr"><input type="text" size="60" name="post[address]" id="address" value="<?php echo $address;?>" maxlength="200"/>&nbsp;<span id="daddress" class="f_red"></span></td>
</tr>
...
<tr>
<td class="tl">&nbsp;</td>
<td class="tr" height="30"><input type="submit" name="submit" value=" 修 改 " class="btn"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value=" 返 回 " class="btn" onclick="history.back(-1);"/></td>
</tr>
</table>
</form>
...
function validator(id) {
	...
	vid = id;
	makeRequest('moduleid=<?php echo $moduleid;?>&action=member&job='+id+'&value='+$(id).value+'&userid=<?php echo $userid;?>', AJPath, '_validator');
}
function _validator() {
...
function Dcheck() {
	...
	if($('payword').value != '') {
		...
		if($('payword').value != $('cpayword').value) {
			Tab(1);
