...
<tr>
<td class="tab" id="action"><a href="<?php echo $MOD['linkurl'];?>record.php"><span><?php echo $DT['money_name'];?>流水</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="action_charge"><a href="<?php echo $MOD['linkurl'];?>charge.php?action=record"><span>充值记录</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="action_cash"><a href="<?php echo $MOD['linkurl'];?>cash.php?action=record"><span>提现记录</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="action_credit"><a href="<?php echo $MOD['linkurl'];?>credits.php?action=record"><span><?php echo $DT['credit_name'];?>记录</span></a></td>
<td class="tab_nav">&nbsp;</td>
<td class="tab" id="action_pay"><a href="<?php echo $MOD['linkurl'];?>record.php?action=pay"><span>信息查看记录</span></a></td>
</tr>
</table>
</div>
<?php if($action == 'pay') { ?>
