...
<?php if($member) { ?>
	...
	<li><span>会员</span> <a href="<?php echo $MODULE['2']['linkurl'];?>friend.php?action=add&username=<?php echo $member['username'];?>">[加为商友]</a> <a href="<?php echo $MODULE['2']['linkurl'];?>message.php?action=send&touser=<?php echo $member['username'];?>">[发送信件]</a> <a href="<?php echo $MODULE['2']['linkurl'];?>favorite.php?action=add&title=<?php echo urlencode($member['company']);?>&url=<?php echo urlencode($member['linkurl']);?>" class="t">[收藏公司]</a></li>
