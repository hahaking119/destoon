...
<?php $tags=tag("moduleid=$moduleid&condition=status=3 and level=1&order=".$MOD['order']."&length=30&pagesize=".$MOD['page_irec']."&template=null")?>
<div class="thumb">
<table width="100%">
...
<div class="m">
	<div class="m_l f_l">
		...
		<td valign="top" width="320">
			...
			<div class="box_body"><div class="thumb"><?php echo tag("moduleid=$moduleid&catid=".$c['catid']."&condition=status=3&order=".$MOD['order']."&length=20&width=120&height=90&pagesize=".$MOD['page_icat']."&cols=2&datetype=3&template=list-video");?></div></div>
			<div class="b10"></div>			
		</td>
