...
<td><input type="text" name="title" value="<?php if($job=='inquiry' || $job=='price') { ?>我对贵公司的“<?php echo $title;?>”很感兴趣<?php } else if($job=='order') { ?>【订购】贵公司的“<?php echo $title;?>”<?php } ?>" size="60" id="title" class="pd3"/></td>
</tr>
<tr>
