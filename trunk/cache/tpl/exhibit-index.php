...
<div class="m">
	...
	<div class="m_r f_l">
		...
		<div class="thumb"><?php echo tag("moduleid=".$MOD['news_id']."&condition=status=3 and thumb!=''&catid=".$MOD['cat_news']."&pagesize=2&length=20&order=addtime desc&width=100&height=90&cols=2&template=thumb-table&target=_blank");?></div>
