...
<div class="know_list">
	<table>
	<tr>
		<td align="left"><ul><li><?php if($t['credit']) { ?><span class="know_credit"><?php echo $t['credit'];?></span> <?php } ?><a href="<?php echo $t['linkurl'];?>" target="_blank" title="<?php echo $t['alt'];?>" class="konw_a"><?php echo $t['title'];?></a></li></ul></td>
