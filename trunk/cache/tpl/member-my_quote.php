...
<?php if($MG['quote_limit'] || (!$MG['fee_mode'] && $MOD['fee_add'])) { ?>
<div class="limit">
<?php if($MG['quote_limit']) { ?>
总共可发 <span class="f_b f_red"><?php echo $MG['quote_limit'];?></span> 条&nbsp;&nbsp;&nbsp;
...
可免费发布 <span class="f_b"><?php if($MG['quote_free_limit']<0) { ?>无限<?php } else { ?><?php echo $MG['quote_free_limit'];?><?php } ?></span> 条&nbsp;&nbsp;&nbsp;
<?php } ?>
</div>
<?php } ?>
